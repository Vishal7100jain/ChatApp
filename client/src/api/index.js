...
const API = axios.create({
  baseURL: "https://chatbuuddy.netlify.app.com/api",
});
...
export const Conversation = async (id) =>
  API.get(`/friend/Conversations/${id}`);
export const SendMessage = async (data, id) =>
  API.post(`/message/SendMessage/${id}`, data);
export const GetMessages = async (id) => API.get(`/message/GetMessages/${id}`);
export const SetEmojiOnMessage = async (id, emoji) =>
  API.patch(`message/Emoji/${id}`, emoji);
