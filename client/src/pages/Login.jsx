                ...
                <form onSubmit={(e) => handleSubmit(e)}>
                    <div>
                        ...
                        <label className="input input-bordered flex items-center gap-2 m-5">
                            ...
                            <input type={showemail ? "email" : 'text'} className="grow" placeholder='email' value={Data.email} onChange={(e) => SetData({ ...Data, email: e.target.value })} />
                            <div onClick={() => { setShowemail((pre) => !pre) }} style={{ cursor: 'pointer' }}>
